...
const sumaNotas = exams.reduce((accumulador, exam) => accumulador + exam.score, 0);

console.log("la suma total de llas notas es: " + sumaNotas);
...
const totalMedia = exams.reduce((acc, exam) => acc + exam.score, 0);
const media = totalMedia / exams.length;
console.log(media);